...
public class Incoming_Message {
	...
	public Incoming_Message(int recipientAddress, Timestamp lastUpdateTime, int retryCount,
		...
		this.messageId=(int) (System.currentTimeMillis() & 0xfffffff);
		this.lifecycleStatusId =(int) (System.currentTimeMillis() & 0xfffffff);
		this.messageContentId = (int) (System.currentTimeMillis() & 0xfffffff);
		this.bulkTransactionId =(int) (System.currentTimeMillis() & 0xfffffff);
		this.sessionGroupId = (int) (System.currentTimeMillis() & 0xfffffff);
